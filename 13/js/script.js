...
/* harmony import */ var _prize_numbers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./prize-numbers.js */ "./source/js/modules/prize-numbers.js");
      ...
      setTimeout(() => {
        ...
        if (this.screenElements[this.activeScreen].getAttribute('id') == 'prizes') {               
          if (!this.prizeAnimationStart) {
            ...
            const prizeNum = new _prize_numbers_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
            prizeNum.tick();
          }
        }
...
/***/ "./source/js/modules/helpers/animation.js":
/*!************************************************!*\
  !*** ./source/js/modules/helpers/animation.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.js */ "./source/js/modules/helpers/utils.js");
...
class Scene2D {
    ...
    updateSize() {
      if (window.innerWidth/window.innerHeight > this.defaultWidth/this.defaultHeight) {
        this.size = window.innerWidth*0.6;
      } else {
        this.size = window.innerHeight*1.1;
      }
...
/***/ "./source/js/modules/helpers/utils.js":
/*!********************************************!*\
  !*** ./source/js/modules/helpers/utils.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/prize-numbers.js":
/*!********************************************!*\
  !*** ./source/js/modules/prize-numbers.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return prizeNumbers; });
class prizeNumbers {
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const resultScene = new _scene_2d_sea_calf_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/* harmony import */ var _helpers_animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/animation.js */ "./source/js/modules/helpers/animation.js");
/* harmony import */ var _helpers_scene_2d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/scene-2d.js */ "./source/js/modules/helpers/scene-2d.js");
/* harmony import */ var _helpers_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/utils.js */ "./source/js/modules/helpers/utils.js");




const IMAGES_PATH = '/img/module-4/win-primary-images/';

const IMAGES_URLS = Object.freeze({
  plane: `${IMAGES_PATH}airplane.png`,
  tree: `${IMAGES_PATH}tree.png`,
  tree2: `${IMAGES_PATH}tree-2.png`,
  ice: `${IMAGES_PATH}ice.png`,
  seaCalf: `${IMAGES_PATH}sea-calf-2.png`,
...
class Scene2DSeaCalf extends _helpers_scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
...
/* harmony import */ var _modules_accent_text__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accent-text */ "./source/js/modules/accent-text.js");
// modules
...
const animationTopScreenTitle = new _modules_accent_text__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__title`, 635, `active`, `transform`, `ease`, [4,2,0,2,3,2,0,6,3,0,3,1,4,5,3,0,4,1], false),
      animationTopScreenDate = new _modules_accent_text__WEBPACK_IMPORTED_MODULE_9__["default"](`.intro__date`, 635, `active`, `transform`, `ease`, [3,2,0,4,1,0,2,5,2,0,4,3,1], true, 600),
      animationStoryScreenTitle = new _modules_accent_text__WEBPACK_IMPORTED_MODULE_9__["default"](`.screen--story .slider__item-title`, 635, `active`, `transform`, `ease`, [4,2,0,2,3,2,0]),
      animationPrizesScreenTitle = new _modules_accent_text__WEBPACK_IMPORTED_MODULE_9__["default"](`.prizes__title`, 635, `active`, `transform`, `ease`, [4,2,0,2,3]),
      animationRulesScreenTitle = new _modules_accent_text__WEBPACK_IMPORTED_MODULE_9__["default"](`.rules__title`, 635, `active`, `transform`, `ease`, [5,2,1,0,3,2,0]),
      animationGameScreenTitle = new _modules_accent_text__WEBPACK_IMPORTED_MODULE_9__["default"](`.game__title`, 635, `active`, `transform`, `ease`, [6,3,0,2]);
